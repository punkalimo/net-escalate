...
const interfaceMetricsSchema = new mongoose.Schema(
  {
    ifIndex: { type: Number, default: null }, speedMbps: { type: Number, default: null }, speedSource: { type: String, default: null }, duplex: { type: String, default: "UNKNOWN" }, inOctets: { type: Number, default: 0 }, outOctets: { type: Number, default: 0 }, octetSource: { type: String, enum: ["HC", "legacy", null], default: null }, inErrors: { type: Number, default: 0 }, outErrors: { type: Number, default: 0 }, inDiscards: { type: Number, default: 0 }, outDiscards: { type: Number, default: 0 }, inBps: { type: Number, default: null }, outBps: { type: Number, default: null }, utilizationPercent: { type: Number, default: null }, sampleIntervalSeconds: { type: Number, default: null }, checkedAt: { type: Date, default: null }, health: { type: String, enum: ["HEALTHY", "WARNING", "DEGRADED", "CRITICAL", "DOWN", "UNKNOWN"], default: "UNKNOWN" }, healthScore: { type: Number, default: null }, healthReasons: { type: [String], default: [] }, activeIncidentId: { type: String, default: null }
  }, { _id: false }
);
